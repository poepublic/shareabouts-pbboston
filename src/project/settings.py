...
if 'SHAREABOUTS_BALLOTBOX_ID' in env:
    SHAREABOUTS['BALLOTBOX_ID'] = env.get('SHAREABOUTS_BALLOTBOX_ID')
if 'SHAREABOUTS_BALLOTBOX_KEY' in env:
    SHAREABOUTS['BALLOTBOX_KEY'] = env.get('SHAREABOUTS_BALLOTBOX_KEY')
