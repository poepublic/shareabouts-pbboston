...
neighborhoods = gpd.read_file(DATA_DIR / 'Boston_Neighborhood_Boundaries.geojson')
...
neighborhoods.to_file(DATA_DIR / 'Boston_Neighborhood_Boundaries_Simplified.geojson', driver='GeoJSON')
