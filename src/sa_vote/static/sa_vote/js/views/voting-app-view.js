...
const MOCK_BALLOT = { // to do: replace with ballot info in md files
  proposals: [
    ...
    { slug: 'renew-roxbury-library', title: 'Roxbury Branch Library Renovation', image_alt: 'People reading in a library', amount: 800000, description: 'Upgrade HVAC, lighting, and accessibility features at the Roxbury branch of the Boston Public Library.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'expand-community-garden', title: 'Community Garden Expansion', image_alt: 'Senior citizens gardening', amount: 150000, description: 'Add raised beds, a tool shed, and a rainwater collection system to three neighborhood community gardens.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    ...
    { slug: 'install-public-art', title: 'Public Art Installation', image_alt: 'Colorful mural on a building wall', amount: 100000, description: 'Commission local artists to create murals and sculptures in public spaces to enhance community identity and pride.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'bus-shelter-upgrades', title: 'Bus Shelter Upgrades', image_alt: 'People waiting at a bus shelter', amount: 200000, description: 'Install new bus shelters with seating, lighting, and real-time arrival information at key transit stops.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'renew-community-centers', title: 'Community Center Renovation', image_alt: 'People participating in activities at a community center', amount: 500000, description: 'Renovate the local community center to include new meeting rooms, a fitness area, and updated technology for community programs.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'plant-street-trees', title: 'Street Tree Planting Program', image_alt: 'Newly planted street trees along a sidewalk', amount: 300000, description: 'Plant new street trees and maintain existing ones to improve air quality, provide shade, and enhance neighborhood aesthetics.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'traffic-calming-measures', title: 'Traffic Calming Measures', image_alt: 'Speed bumps on a residential street', amount: 250000, description: 'Implement traffic calming measures such as speed bumps, curb extensions, and pedestrian islands to improve safety in residential areas.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'enhance-recycling', title: 'Enhanced Recycling Program', image_alt: 'Recycling bins in a public area', amount: 100000, description: 'Expand recycling services to include more materials and provide educational programs to encourage community participation.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
    { slug: 'expand-public-wifi', title: 'Public Wi-Fi Expansion', image_alt: 'People using laptops in a public park', amount: 150000, description: 'Install public Wi-Fi hotspots in parks and community centers to improve internet access for residents.', image: Shareabouts.bootstrapped.staticUrl + 'ballot/neighborhood-fresh-food.jpg' },
  ],
};
